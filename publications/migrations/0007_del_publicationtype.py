...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
      ...
      db.add_column('publications_publication', 'type', models.CharField(null=True, max_length=16))
      db.execute("UPDATE publications_publication SET type = type_id")
      db.delete_column('publications_publication', 'type_id')

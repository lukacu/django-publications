...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Publication.type'
        db.delete_column('publications_publication', 'type')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Publication.type'
        raise RuntimeError("Cannot reverse this migration. 'Publication.type' and its values cannot be restored.")

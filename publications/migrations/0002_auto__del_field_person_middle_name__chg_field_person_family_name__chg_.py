...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('publications_person', 'middle_name')

        # Changing field 'Person.family_name'
        db.alter_column('publications_person', 'family_name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Person.primary_name'
        db.alter_column('publications_person', 'primary_name', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Adding field 'Person.middle_name'
        db.add_column('publications_person', 'middle_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True), keep_default=False)

        # Changing field 'Person.family_name'
        db.alter_column('publications_person', 'family_name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Person.primary_name'
        db.alter_column('publications_person', 'primary_name', self.gf('django.db.models.fields.CharField')(max_length=100))
